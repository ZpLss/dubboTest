...
//				logger.debug("传给接口["+url+"]参数:"+"["+me.getKey()+"]="+(String) me.getValue());
...
//		// map, "utf-8");
//		String str = httpJsonPost("http://127.0.0.1:8088/wx/active/test", "{\"a\":1}");
//
...
//		return sb.toString();
	 ...
	 * @throws Exception
	 */
	public static String uploadFileImpl(String url, File file,
