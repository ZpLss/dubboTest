...
public class PropertiesLoader {
	...
	public PropertiesLoader(String... resourcesPaths) {
		properties = loadProperties(null, resourcesPaths);
	}

	public PropertiesLoader(Charset charset, String... resourcesPaths) {
		properties = loadProperties(charset, resourcesPaths);
	}
	 ...
	 * @param charset 编码
	 */
	private Properties loadProperties(Charset charset, String... resourcesPaths) {
